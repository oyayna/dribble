...
const ForgetPassword = () => {
  const { forget_passwordUser } = useContext(AuthContext);
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await forget_passwordUser(trimmedEmail);
      ...
      <section className="content">
        <div className="auth auth2">
          <div className="auth-content-v3">
            ...
            {messages.success && (
              <div className="alert-success">{messages.success}</div>
            )}
            {messages.error && (
            ...
            <div className="sign-form">
              <form onSubmit={handleSubmit}>
                <div className="form-field">
                  ...
                  <input
                    style={messages.email ? { backgroundColor: "#ffeeee" } : {}}
