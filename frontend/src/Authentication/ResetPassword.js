...
const ResetPassword = () => {
  const { re_passwordUser } = useContext(AuthContext);
  ...
  const handleSubmit = async (e) => {
    ...
    const trimmedConfirmPassword = confirm_new_password.trim();
    let hasError = false;
    const newErrors = {};

    // NewPassword validation
    if (!trimmedPassword) {
      newErrors.new_password = "Password is required. Please enter a password.";
      hasError = true;
    ...
    const response = await re_passwordUser(
      email,
      token,
      trimmedPassword,
    ...
    const data = {
      ...
      new_password: response.new_password ? response.new_password : "",
      confirm_new_password: response.confirm_new_password
        ? response.confirm_new_password
        : "",
    };
    ...
    <main className="main-container">
      <section className="auth-sidebar">
        <div className="auth-sidebar-content">
          ...
          >
            <source
              src={"../assets/Videos/b8bd4e4273cceae2889d9d259b04f732.mp4"}
              type="video/mp4"
            />
      ...
      <section className="content">
        <div className="auth auth2">
          <div className="auth-content-v3">
            ...
            <div className="sign-form">
              <form onSubmit={handleSubmit}>
                <div className="form-field">
                  ...
                  />
                  {messages.new_password && (
                    <p className="handlaerror">{messages.new_password}</p>
                  )}
                </div>
                <div className="form-field">
                  <div className="handlaerror">
                    ...
                    <label htmlFor="user_name">Confirm New Password</label>
                  </div>
                  <input
                    style={
                      messages.confirm_new_password
